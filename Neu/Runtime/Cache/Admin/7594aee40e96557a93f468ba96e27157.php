...
<html>
    <head>
        ...
        <link href="/evaluate2.1/Public/css/admin.css" type="text/css" rel="stylesheet" />
    </head>
    <body>
        <table cellspacing=0 cellpadding=0 width="100%" align=center border=0>
            <tr height=28>
                <td background="/evaluate2.1/Public/images/title_bg1.jpg">当前位置: >>  后台管理首页</td></tr>
            <tr>
                <td bgcolor=#b1ceef height=1></td></tr>
            <tr height=20>
                <td background=/evaluate2.1/Public/images/shadow_bg.jpg></td></tr></table>
        ...
        <table cellspacing=0 cellpadding=0 width="95%" align=center border=0>
            ...
            <tr height=22>
                <td style="padding-left: 20px; font-weight: bold; color: #ffffff" 
                    align=middle background="/evaluate2.1/Public/images/title_bg2.jpg">您的相关信息</td></tr>
