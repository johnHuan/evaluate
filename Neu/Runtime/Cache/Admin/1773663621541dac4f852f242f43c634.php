...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/evaluate2.1/Public/bootstrap/css/bootstrap.min.css">
        ...
        <script src="/evaluate2.1/Public/js/jquery-1.7.2.min.js" type="text/javascript"></script>
            ...
            <tr>
                <td>
                    <?php if(is_array($auth_infoA)): foreach($auth_infoA as $k=>$vo): ?><table class="table">
                            <tr>
                                <td><a onclick="javascript:expand(<?php echo ($vo["auth_id"]); ?>)"  href="javascript:void(0);"><span class="glyphicon glyphicon-cog"><?php echo ($vo["auth_name"]); ?></span></a></td>
                            </tr>
                        </table>
                        <table class="table" id="child<?php echo ($vo["auth_id"]); ?>" style="display: none" >
                            <?php if(is_array($auth_infoB)): foreach($auth_infoB as $kk=>$voo): if(($vo["auth_id"]) == $voo["auth_pid"]): ?><tr>
                                        ...
                                        <td width="180"><a href="/evaluate2.1/index.php/Admin/<?php echo ($voo["auth_c"]); ?>/<?php echo ($voo["auth_a"]); ?>" target="right"><span class="glyphicon glyphicon-circle-arrow-right"><?php echo ($voo["auth_name"]); ?></span></a></td>
