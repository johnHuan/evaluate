...
<body>
<nav>当前位置：数据库管理 >>添加角色</nav>
<div class="container">
<hgroup>
    <h4> <span class="text-primary ">添加角色</span></h4>
</hgroup>
<form role="form" action="/evaluate2.1/index.php/Admin/Auth/addRole" method="post">
    <div class="table-responsive">
        <table class="table table-condensed table-hover table-bordered " style="width: 80%">
            <tr>
                <td><?php echo ($fields[0]); ?></td>
                <td><input name="role_id" class="form-control inline-input" type="text"></td>
            </tr>
            <tr>
                <td><?php echo ($fields[1]); ?></td>
                <td><input name="role_name" class="form-control inline-input" type="text"></td>
            </tr>
            <tr>
                <td><?php echo ($fields[2]); ?></td>
                <td><input name="role_auth_ids" class="form-control inline-input" type="text"></td>
            </tr>
            <tr>
                <td><?php echo ($fields[3]); ?></td>
                <td><input name="role_auth_ac" class="form-control inline-input" type="text"></td>
            </tr>
