        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-sm-12">
                    <form id="login" action="/evaluate2.1/index.php/Admin/Manager/Login.html" class="form-horizontal" method="post">
...
<script>
    ...
    /*
     ...
     //url: '/evaluate2.1/index.php/Admin/Manager/Login.html',
     beforeSend: function(){
