...
<body>
<nav>当前位置：数据管理 >> 上传学生信息</nav>
<div class="container">
    <div>
        <h3>上传学生信息</h3>
        <h4 class="modal-title" id="myModalLabel">请选择Excel文件</h4>
    </div>
    <form method="post" action="/evaluate2.1/index.php/Admin/Index/uploadstu" enctype="multipart/form-data">
        <input type="file" id="student" multiple name="student" class="file-loading" data-preview-file-type="text">
    ...
    <form id="form1" action="/evaluate2.1/index.php/Admin/Index/uploadstu" class="form-horizontal" method="post">
        <h3>写入数据库</h3>
...
<script src="/evaluate2.1/Public/bootstrapfileinput/js/fileinput.min.js"></script>
...
<script>
    $("#student").fileinput({
//        uploadUrl: "/evaluate2.1/index.php/Admin/Index/uploadstu", // server upload action
        uploadUrl: "/evaluate2.1/index.php/Admin/Index/uploadstu", // server upload action
        uploadAsync: true,
        showPreview: true,
    ...
    $(function(){
        ...
        $('#submit').on('click', function(event){
            ...
            $.ajax({
                type: 'POST',
                url: '/evaluate2.1/index.php/Admin/Index/uploadstu',
                data: {
                    captcha: captcha,
                    info: info,
                },
